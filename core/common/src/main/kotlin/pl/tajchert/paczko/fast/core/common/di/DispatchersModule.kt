package pl.tajchert.paczko.fast.core.common.di
 ...
 *    `@Dispatcher(PaczkofastDispatchers.IO)` is more explicit than just using `Dispatchers.IO`.
 *
 ...
 *     @Dispatcher(PaczkofastDispatchers.IO) private val ioDispatcher: CoroutineDispatcher,
 * ) {
...
annotation class Dispatcher(val dispatcher: PaczkofastDispatchers)

/**
 * Enum of available dispatchers for dependency injection.
 */
enum class PaczkofastDispatchers {
    /**
...
object DispatchersModule {
    ...
    @Provides
    @Dispatcher(PaczkofastDispatchers.IO)
    fun providesIODispatcher(): CoroutineDispatcher = Dispatchers.IO

    @Provides
    @Dispatcher(PaczkofastDispatchers.Default)
    fun providesDefaultDispatcher(): CoroutineDispatcher = Dispatchers.Default

    @Provides
    @Dispatcher(PaczkofastDispatchers.Main)
