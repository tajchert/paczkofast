package pl.tajchert.paczko.fast.core.network.fake
...
class FakeTaskNetworkDataSource @Inject constructor(
    ...
    private val tasks = mutableListOf(
        ...
        NetworkTask(
            ...
            description = "Build design system with PaczkofastTheme, PaczkofastButton, PaczkofastCard and other wrapped Material 3 components.",
            isCompleted = false,
